...
`;
    ...
    return (
        <>
            <main className="font-Lexend bg-black w-full min-h-screen flex flex-col items-center justify-center">
                {/* logo of the website */}
                <h1 className="text-white/80 text-2xl sm:text-4xl tracking-wider">.analytiX</h1>
